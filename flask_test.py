...
class FlaskappTests(unittest.TestCase):
    ...
    ##def test_addusers_status_code(self):
     ...
     #   result = self.app.post('/api/v1/users', data='{"username":"shami", "email":"shami@gmail.com", "password": "test123"}',content_type = 'application/json')
     #   print(result)
        # assert the status code of the response
    ...
    def test_addtweets_status_code(self):
        # sends HTTP GET request to the application
        # on the specified path
        result = self.app.post('/api/v2/tweets', data='{"username":"hashim", "body":"Wow! Is it working #testing"}',
